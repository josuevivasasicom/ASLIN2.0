...
//$fontname = TCPDF_FONTS::addTTFfont('calibri/calibri-bold.ttf', 'TrueTypeUnicode', '', 96);
//$html2pdf->addFont('calibri','','calibri.php');
//echo $html;
$html = str_replace('Calibri,sans-serif','',$html);
