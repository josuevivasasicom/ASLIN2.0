...
<body>
    <div class="section section-image section-login" data-src="./assets/img/bg/1.jpg"
        style="background-size:cover; background-image: url('./assets/img/bg/1.1.jpg'); height:100vh">
        <div class="container p-1">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-md-12 d-flex align-items-center justify-content-center flex-column">
                    <img src="assets/img/logo_login.gif" class="img-logo" alt="">
                </div>
                <div class="col-md-12 d-flex align-items-center justify-content-center flex-column">
                    <!-- LOGIN -->
                    <div class="back-image d-flex align-items-center  flex-column" style="margin-top:10vh">
                        ...
                        <form id="fomLogin" class="register-form error" action="./?action=login" method="POST"
                            ...
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" style="padding-right: 7px;">
                                        <i class=""><img src="assets/img/icons/email.png" alt="" srcset=""></i>
                                    </span>
                                </div>
                                <input autocomplete="nope" name="email" type="email" class="form-control"
                                    placeholder="Email">
                            </div>
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span id="spanAction" onclick="revealPAss()" class="input-group-text"
                                        style="cursor:pointer;padding-right: 7px;">
                                        <i class=""><img src="assets/img/icons/password.png" alt="" srcset=""></i>
                                    </span>
                                </div>
                                <input autocomplete="off" id="pass" name="pass" type="password" class="form-control"
                                    placeholder="Password">
                            </div>
                            <button onclick="cargando()" class="btn btn-ingresar btn-block btn-round">Entrar</button>
                        </form>
                        <?php 
              ini_set('display_errors', 0);
              ini_set('display_startup_errors', 0);
              ...
              ?>
                    ...
                    <div class="d-none card card-password p-3 d-none" style="margin-top:25vh">
                        ...
                        <form class="recovery-password">
                            ...
                            <button onclick="sendCheckPassRecovery()"
                                class="btn btn-warning btn-block btn-round">Enviar</button>
                        </form>
                        <?php 
              ini_set('display_errors', 0);
              ini_set('display_startup_errors', 0);
...
function sendCheckPassRecovery() {
    ...
    axios.post('./?action=recoveryPass&mail=' + email, {
            method: 'solicitud',
            email: email
        })
