...
$_phpmailer_autoload = "./assets/plugins/phpmailer/PHPMailer/PHPMailerAutoload.php";
$_phpmailer_vendor =   "./assets/plugins/phpmailer/vendor/autoload.php";

class Mails{
    public static $remitente = "contacto@localhost.com";
    public static $nombreRemitente = "";
    public static $asicomMail = "";
    public static $diemsaMail = "contacto@localhost.com";
    public static $msj_test='';

    /* ***************************[ CONFIGURACION DEL SENDER DE EMAIL ]*********************************** */
    public static function sendMail($msg,$email,$subject,$debug=0){
        require_once "./assets/plugins/phpmailer/PHPMailer/PHPMailerAutoload.php";
        require_once "./assets/plugins/phpmailer/vendor/autoload.php";

        $mail = new PHPMailer;
        $mail->SMTPDebug  = $debug;
        $mail->CharSet = 'UTF-8';
        $mail->isMail();
        $mail->setFrom('desarrollo@asicomsystems.com.mx', 'CMA application');
        $mail->addReplyTo('desarrollo@asicomsystems.com.mx', 'CMA application');
        $mail->Subject = $subject;
        $mail->addAddress($email);
        $mail->msgHTML($msg);
       /*  ******************************* PAUSANDO EL SISTEMA DE ENVIO DE CORREOS 
        if(!$envio = $mail->Send()){
            echo "ERROR";
        }
        else{
       ...
       /* ***************************[ correo de creacion de siniestro ]*********************************** */
    //REVIEW ....
    //@param $data  Son todos los datos del siniestro ID para generar los correos de nueva creacion de ID
    public static function send_mail_new_id($datos){
        $subject='Nuevo ID se ha creado'.$datos['folio'];
        //* inicia REDACCION DEL EMIAL
        $msg = `
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                    ...
                                                                                                    <table width="105" border="0" align="left" cellpadding="0" cellspacing="0" class="two-left">
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td align="center" valign="top">
                                                                                                                    <a href="#"><img src="https://asicom.systems/democma/assets/img/logo_large_white.png" width="200" height="22" alt="" style="width: 200px;height: auto;"></a>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td align="left" valign="top" bgcolor="#ae9a49" style="background:#ae9a49;">
                                                                    ...
                                                                    <table width="320" border="0" align="right" cellpadding="0" cellspacing="0" class="full">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center" valign="top"><img src="http://asicom.systems/democma/assets/img/icons/created.png" width="320" height="435" alt="" style="display:block;width:100% !important; height:auto !important;"></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                                                        <tbody>
                                                            <tr>
                                                                <td align="left" valign="top" bgcolor="#FFFFFF" style="background:#FFF;"><img src="https://asicom.systems/democma/assets/img/bg/1.1.jpg" width="700" height="310" alt="" style="display:block;width:100% !important; height:auto !important;"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
        ...
        `;
        //* fin REDACCION DEL EMIAL

        header("location: ./?action=test&param".$msg);
        //print $msg;
        exit();

        //?MECANISMO DE ENVIO DE CORREO
        foreach ($datos['abogados'] as $abogado) {
           $email = UserData::get_email_user($abogado);
           self::sendMail($msg,$email,$subject); //?enviar correo
           ///! añadir sentencia para ver si se envio correo o no. tabla de registro de envios de correos y alertas
           //añadir tabla de alertas por usuarios, deben abrir sus notificaciones para marcar como leidas.
        }
