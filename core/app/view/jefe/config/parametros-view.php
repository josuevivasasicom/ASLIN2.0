        ...
        <div class="row justify-content-md-center">
            ...
            <div class="col-md-10">
                ...
                <!-- <button class="btn btn-danger" data-toggle="modal" data-target="#myModal">Launch demo modal</button> -->
                    ...
                    <div class="row">
                        <div class="update ml-auto mr-4"> <!-- centrado <div class="update ml-auto mr-auto"> -->
                            <button type="button" onclick="newTypeFile()" class="btn btn-primary btn-round" data-toggle="modal" data-target="#newProveniente" >Añadir Proveniente</button>
                        </div>
                    </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <!-- <button class="btn btn-danger" data-toggle="modal" data-target="#myModal">Launch demo modal</button> -->
                        <div class="row">
                            <div class="update ml-auto mr-4"> <!-- centrado <div class="update ml-auto mr-auto"> -->
                                <button type="submit" class="btn btn-primary btn-round" data-toggle="modal" data-target="#newProveniente" >Añadir Institución</button>
                            </div>
                        </div>
                    <div class="card-body">
                        <div class="table-responsive">
            ...
            <div class="col-md-6">
                ...
                <!-- <button class="btn btn-danger" data-toggle="modal" data-target="#myModal">Launch demo modal</button> -->
                    ...
                    <div class="row">
                        <div class="update ml-auto mr-4"> <!-- centrado <div class="update ml-auto mr-auto"> -->
                            <button type="submit" class="btn btn-primary btn-round" data-toggle="modal" data-target="#newAutoridad" >Añadir Autoridad</button>
                        </div>
                    </div>
    ...
    ******/
    ...
    function editInst(inst) {
        ...
        if(inst.activo=='Activo'){
          ...
          let html_ = ` <input type="text" id="institucion"          value="`+inst.valor.toUpperCase()+`"    class="swal2-input" placeholder="institucion" style="text-transform: uppercase;width:90%;">
                        <input type="hidden" id="id"   value="`+inst.id+`"    class="swal2-input" placeholder="id" style="text-transform: uppercase;width:90%;">`;
        html_ = html_ + selInput;
        Swal.fire({
        confirmButtonColor: 'var(--color-blanco)',
        denyButtonColor: 'var(--color-blanco)',
        ...
        focusConfirm: false,
        preConfirm: () => {
            const id = Swal.getPopup().querySelector('#prov').value
            const institucion = Swal.getPopup().querySelector('#descripcion').value
            const estatus = Swal.getPopup().querySelector('#estatus').value
    ...
    function editAutoridad(autoridad) {
       ...
       console.log(autoridad);
        ...
        if(autoridad.activo=='Activo'){
          ...
          let html_ = ` <input type="text" id="autoridaditucion"          value="`+autoridad.valor.toUpperCase()+`"    class="swal2-input" placeholder="autoridaditucion" style="text-transform: uppercase;width:90%;">
                        <input type="hidden" id="id"   value="`+autoridad.id+`"    class="swal2-input" placeholder="id" style="text-transform: uppercase;width:90%;">`;
        html_ = html_ + selInput;
        Swal.fire({
        confirmButtonColor: 'var(--color-blanco)',
        denyButtonColor: 'var(--color-blanco)',
        ...
        preConfirm: () => {
            const id = Swal.getPopup().querySelector('#prov').value
            const autoridaditucion = Swal.getPopup().querySelector('#descripcion').value
            const estatus = Swal.getPopup().querySelector('#estatus').value
            
            if (!id || !autoridaditucion || !estatus) {
            Swal.showValidationMessage(`No puedes dejar campos en blanco`)
            }
            return { id,autoridaditucion,estatus}
        }
        }).then((cambios) => {
            // console.log (cambios.isConfirmed);
           ...
           if (cambios.isConfirmed)
             $.ajax({
                url: "./?action=config/param&modo=autoridaditucion&edit=autoridad",
                method: "POST",
                data: {'data':cambios.value} ,
                success: function(respuesta) {
                    // dataset = JSON.parse(respuesta);
