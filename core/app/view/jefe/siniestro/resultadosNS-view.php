...
if(!isset($_REQUEST['searchNS']) || $_REQUEST['searchNS']=='')
header('Location: ?view=index');


core::sendStringToJs($_REQUEST['searchNS'],'searchNS');
...
<script type="text/javascript" defer>
    ...
    localStorage.setItem('soloAsignados', false); */
        ...
        function leerTablaSiniestros() {
            ...
            paramProvAjax = paramProv + paramStatus + paramArea + paramCalificacion + soloAsignados + paramAbo + '&searchNS='+searchNS; //proveniente seleccionado desde los botones
           
            paramNombres = (nombreProv.toUpperCase())+' '+nombreStatus+nombreCalificacion+nomArea+nombreAsign;

            $('#tablaSiniestrosTodos').jtable({
                title: 'Busqueda por NS '+paramNombres,
                messages:{
                ...
                actions: {
                    listAction: '?action=jtable/tablaSiniestrosSearchNS.ajax'+paramProvAjax,
