<?php
//? ESTOS SON LOS RESULTADOS DE SERACHASEGURADO, DEBE MOSTRAR UN LISTADO CON LOS IDS QUE COINCIDEN CON LA BUSQUEDA.

if(!isset($_REQUEST['searchAsegurado']) || $_REQUEST['searchAsegurado']=='')
header('Location: ?view=index');


core::sendStringToJs($_REQUEST['searchAsegurado'],'searchAsegurado');
                        ...
                        <div id="accordion">
                            <div class="card">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <button class="btn  btn-prinone btn-round my-0" style="float:right" onclick="leerTablaSiniestros()" id="btn_prov_F">buscar</button>
                                </div>
...
<script type="text/javascript" defer>
    ...
    localStorage.setItem('soloAsignados', false); */
        ...
        function leerTablaSiniestros() {
            ...
            paramProvAjax = paramProv + paramStatus + paramArea + paramCalificacion + soloAsignados + paramAbo + '&searchAsegurado='+searchAsegurado; //proveniente seleccionado desde los botones
           
            paramNombres = (nombreProv.toUpperCase())+' '+nombreStatus+nombreCalificacion+nomArea+nombreAsign;

            $('#tablaSiniestrosTodos').jtable({
                title: 'Busqueda '+paramNombres,
                messages:{
                    noDataAvailable: 'Tu busqueda no tiene resultados!',
                    addNewRecord: 'añadir',
                    editRecord: 'edit',
                },
                edit: true,
                ...
                actions: {
                    listAction: '?action=jtable/tablaSiniestrosBuscarTodos.ajax'+paramProvAjax,
