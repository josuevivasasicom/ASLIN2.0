...
/* if ( isset($_REQUEST['searchAsegurado']) and isset($_REQUEST['searchAsegurado']) ){
  header("Location: ./?action=searchID&searchAsegurado=".$_REQUEST['searchAsegurado']);//redirecciona al para buscar siniestro por nombre del asegurado
} */
...
print('<style>.notouch{pointer-events:none; opacity:0.4}' . $cssStyle . '</style>');
...
<div class="modal fade" id="modalCambiaAutoridad" tabindex="null" role="dialog"
	aria-labelledby="modalCambiaAutoridadLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="modalCambiaAutoridadBody">
				<div class="form-group institucionGroup">
					...
					<select class="js-select2-tags form-control" placeholder="Selecciona Autoridad" tag="true"
						name="btnAutoridad" id="btnAutoridad" style="width:100%;" required>
...
<!-- Modal -->
 <!-- Modal se usa como advertencia antes de eliminar un archivo de sinisestos_file !!no borrar-->
 <div class="modal fade" id="modalFileDel" role="dialog" aria-labelledby="modalFileDelLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
	<div class="modal-content">
	  <div class="modal-header">
		<h5 class="modal-title" id="modalFileDelLabel">Modal title</h5>
		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		  <span aria-hidden="true">&times;</span>
		</button>
	  </div>
	  <div class="modal-body" id="modalFileDelBody">
	   ...
	  </div>
	  <div class="modal-footer">
		...
		<button onclick="deleteFile()" plataforma type="button" class="btn btn-danger"><i class="fa fa-trash"></i> Eliminar</button>
...
<div class="modal fade" id="modalCambiaInstitucion" tabindex="null" role="dialog"
	aria-labelledby="modalCambiaInstitucionLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body" id="modalCambiaInstitucionBody">
				<div class="form-group institucionGroup">
					...
					<select class="js-select2-tags form-control" placeholder="Selecciona Institución" tag="true"
						name="btnInstitucion" id="btnInstitucion" style="width:100%;" required>
						<!-- name="states[]" multiple="multiple" -->
...
<div class="modal fade" id="modalCambiaStatus" tabindex="-1" role="dialog" aria-labelledby="modalCambiaStatusLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body" id="modalCambiaStatusBody">
				<div class="form-group statusGroup">
					...
					<select class="js-select2 form-control" placeholder="Selecciona" id="btnstatus" name="btnstatus"
...
<div class="modal fade" id="modalCambiacalificacion" tabindex="-1" role="dialog"
	aria-labelledby="modalCambiacalificacionLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body" id="modalCambiacalificacionBody">
				<div class="form-group calificacionGroup">
					...
					<select class="js-select2 form-control" placeholder="Selecciona Calificación" name="btncalificacion"
						id="btncalificacion" style="width:100%;" required>
						<!-- name="states[]" multiple="multiple" -->
...
<div class="modal fade" id="modalAsignarArea" tabindex="-1" role="dialog" aria-labelledby="modalAsignarAreaLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body" id="modalAsignarAreaBody">
				<div class="form-group col-12">
					<select class="js-select2 form-control" placeholder="Asigna Área" id="asignArea" name="asignArea[]"
						...
						foreach ($areas as $key) { //recorre todas las areas
							...
							if ($existe == 'no') {
								$areasNoasignadas[] = $key;
							} //si no existe en el array de asignadas, lo push a $areasNoasignadas
						}
				...
				<div class="col-12">
					<div class="form-group">
						<select class="js-select2 form-control" place="abogados" placeholder="Asigna Abogado"
							id="abogados" name="abogados[]" multiple="multiple" style="width:100%;">
							<?php
...
<div class="modal fade" id="modalAsignaAbogado" tabindex="-1" role="dialog" aria-labelledby="modalAsignaAbogadoLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body" id="modalAsignaAbogadoBody">
				<div class="form-group">
					<select class="js-select2 form-control" place='abogados' placeholder="Asigna Abogado"
						id="aboAsigndo" name="aboAsigndo[]" multiple="multiple" style="width:100%;">
						<!-- name="states[]"  -->
						...
						foreach ($abogados as $key) { //recorre todos abogados de las areas asignadas
							...
							if ($existe == 'no') {
								$abogadosNoAsignados[] = $key;
							} //si no existe en el array de asignadas, lo push a $abogadosNoAsignados
						}
...
<div class="modal fade" id="modalNuevaEntradaBitacora" tabindex="-1" role="dialog"
	aria-labelledby="modalNuevaEntradaBitacoraLabel" aria-hidden="true">
		...
		<div class="modal-content">
			<form id="newBitacoraModalForm" action="./?action=siniestro/bitacora&metodo=nuevo" method="post">
				...
				<div class="modal-body" id="">
					...
					<input class="campoBitacora" id="horasBitacora" name="horasBitacora" type="number" maxlength="2"
						value="1" min=0.5 max="24" step=".5" required /> hrs. <br>
...
<div class="modal fade" id="modalVerDescricionHechos" tabindex="-1" role="dialog"
	aria-labelledby="modalVerDescricionHechosLabel" aria-hidden="true">
...
<div class="modal fade" id="modalEditDescricionHechos" tabindex="-1" role="dialog"
	aria-labelledby="modalEditDescricionHechosLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
...
<!-- MODAL CARATULA -->
<div class="modal fade" id="modalFileCaratula" role="dialog" aria-labelledby="modalFileCaratulaLabel"
	aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
	...
	<div class="row">
		<div class="col-lg-9 pr-md-0">
			...
			<div class="col-md-12">
				...
				<!-- INICIAN BOTONES DE SEGMENTACION POR AREAS SOLO PARA ADMINISTRADOR DE SINIESTROS Y ADMIN DE APP0 -->
				<?php
				//var_dump($_SESSION);
//echo "->" . $abo['usuario'] . "<-";
				foreach ($sn['areasAsignadas'] as $k) {
					print '<a onclick="panelOpen(\'#collapse' . str_replace(' ', '', $k['area']) . '\')" class="btn btn-primary btn-round" data-toggle="collapse" href="#collapse' . str_replace(' ', '', $k['area']) . '" role="button" aria-expanded="false" aria-controls="collapse' . str_replace(' ', '', $k['area']) . '">' . $k['area'] . '</a>';
				}
				?>
				...
				foreach ($sn['areasAsignadas'] as $k) {
					...
					$oculto = ' ';
					if ($_AreaID == '4' || $_AreaID == '5') {
						$oculto = 'display:none !important;';
					} //si es area 4 o 5 , cntabilidad o administrativa, oculta.
  ...
  <div class="collapse multi-collapse " id="collapse' . $_area . '">
    <div class="row">
      <div class="col  pl-lg-0 pr-lg-0">
        <div class="card-header">
            ...
            <span onclick="changeParam(' . $_AreaID . ',\'status\',\'' . $_AREA . '\')" data-toggle="modal" data-target="#modalCambiaStatus"       class="mr-3 capsule rounded-pill ' . strtolower($sn[$_area]['status']) . '" style="cursor:pointer; float: right;"><b>Status:</b>   ' . $sn[$_area]['status'] . '  </span>
            <span onclick="changeParam(' . $_AreaID . ',\'calificacion\',\'' . $_AREA . '\')" data-toggle="modal" data-target="#modalCambiacalificacion"  class="mr-3 capsule rounded-pill ' . strtolower($sn[$_area]['calificacion']) . ' " style="cursor:pointer; float: right;"><b>Calificación:</b> ' . $sn[$_area]['calificacion'] . '  </span>
        </div>
        <div class="">
          <div claas="">';
					?>
					...
					<div class="card" style="border-radius: 0 0 12px 12px;">
						<div class="card-body">
							<div class="nav-tabs-navigation">
								<div class="nav-tabs-wrapper">
									<ul id="tabs row" class="nav nav-tabs" role="tablist">
										<li onclick="tabOpen('#atencion<?= $_area ?>')" data-name="atencion<?= $_area ?>"
											class="nav-item col px-0 mx-0" style="<?= $oculto; ?>">
											<!-- si el area lo permite, se muestra o se oculta -->
											<a class="nav-link" data-toggle="tab" href="#atencion<?= $_area ?>" role="tab"
												aria-expanded="false" aria-selected="false">Primera Atención</a>
										</li>
										<li onclick="tabOpen('#preliminar<?= $_area ?>')"
											data-name="preliminar<?= $_area ?>" class="nav-item col px-0 mx-0"
											style="<?= $oculto; ?>"> <!-- si el area lo permite, se muestra o se oculta -->
											<a class="nav-link" data-toggle="tab" href="#preliminar<?= $_area ?>" role="tab"
												aria-expanded="false" aria-selected="false">Informe Preliminar</a>
										</li>
										<li onclick="tabOpen('#actualizacion<?= $_area ?>')"
											data-name="actualizacion<?= $_area ?>" class="nav-item col px-0 mx-0"
											style="<?= $oculto; ?>"> <!-- si el area lo permite, se muestra o se oculta -->
											<a class="nav-link" data-toggle="tab" href="#actualizacion<?= $_area ?>"
												role="tab" aria-expanded="false" aria-selected="false">Informe
												Actualización</a>
										</li>
										<li onclick="tabOpen('#documentos<?= $_area ?>')"
											data-name="documentos<?= $_area ?>" class="nav-item col px-0 mx-0">
											<!-- si el area lo permite, se muestra o se oculta -->
											<a class="nav-link" data-toggle="tab" href="#documentos<?= $_area ?>" role="tab"
												aria-expanded="false" aria-selected="false">Documentación Cargada</a>
										</li>
										<li onclick="tabOpen('#cancelacion<?= $_area ?>')"
											data-name="cancelacion<?= $_area ?>" class="nav-item col px-0 mx-0"
											style="<?= $oculto; ?>"> <!-- si el area lo permite, se muestra o se oculta -->
											<a class="nav-link" data-toggle="tab" href="#cancelacion<?= $_area ?>"
												role="tab" aria-expanded="false" aria-selected="false">Informe de
												Cancelación</a>
										</li>
										<li onclick="tabOpen('#bitacora<?= $_area ?>')" data-name="bitacora<?= $_area ?>"
											class="nav-item col px-0 mx-0">
											<!-- si el area lo permite, se muestra o se oculta -->
											<a class="nav-link" data-toggle="tab" href="#bitacora<?= $_area ?>" role="tab"
												aria-expanded="false" aria-selected="false">Bitácora de actividades</a>
										</li>
									</ul>
								</div>
							</div>
							<div id="my-tab-content" class="tab-content text-center">
								...
								<div class="tab-pane text-left mx-5 mt-2" style="<?= $oculto ?>" id="atencion<?= $_area ?>"
                            ...
                            ";
								...
								<div class="tab-pane text-left mx-5 mt-2" style="<?= $oculto ?>"
									id="preliminar<?= $_area ?>" role="tabpanel" aria-expanded="false">
                              ...
                              ";
								...
								<div class="tab-pane text-left mx-5 mt-2" style="<?= $oculto ?>"
									id="cancelacion<?= $_area ?>" role="tabpanel" aria-expanded="false">
                              ...
                              ";
								...
								<div class="tab-pane text-left mx-5 mt-2" style="<?= $oculto ?>"
									id="actualizacion<?= $_area ?>" role="tabpanel" aria-expanded="false">
                              ...
                              ";
										...
										<div class=" row justify-content-md-center">
											...
											<div class="col-12">
												<button style='float: right;' class='btn btn-primary'
													onclick="downloadAsExcelBitacorasID('<?= $sn['timerst'] ?>');">
													Descargar &nbsp; &nbsp;
													<!-- <i class='fa fa-file-excel-o' aria-hidden='true'></i> --> <span
														class="jtable-toolbar-item-icon"
														style="width: 17px;height: 17px;background: url('https://www.jtable.org/Content/images/Misc/excel.png')  no-repeat;position: absolute;"></span>
												</button>
													...
													<table class="table bitacoras">
														...
														if (count($sn[$_area]['bitacora']) >= 1) {
															...
															foreach ($sn[$_area]['bitacora'] as $k) {
																...
																$col .= '</td>';
																$col .= '<td style="text-align:left" >' . urldecode($k['bitacora']) . '</td>' .
											...
											<div class="col-3">
												<button type="button" data-toggle="modal"
													data-target="#modalNuevaEntradaBitacora"
													onclick="prepareModalBitacora('<?= $_AreaID ?>')"
													class="btn btn-primary">Nueva Entrada</button>
											</div>
								...
								<!-- DOCUMENTOS?? -->
								<div class="tab-pane mx-5 mx-5 mt-2" id="documentos<?= $_area ?>" role="tabpanel"
									aria-expanded="false">
									<center>
										<div class="row">
											<div class="col-2">
												<button type="button" onclick="disparadorFile('<?= $_AreaID ?>')"
											...
											<table id="theTable<?=$_AreaID?>" class="display">
												...
												<a id="downloader" href="" download="" style="display:none;">baja
													invisible</a>
										...
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											<li class="nav-item active">
												<a class="nav-link active" data-toggle="tab" href="#descripcion"
													role="tab" aria-expanded="false" aria-selected="true">Descripción de
													los hechos</a>
											</li>
											<?php
											if ($anterioresDescripcionesHechos != 0 && is_array($anterioresDescripcionesHechos)) {
												?>
												<li class="nav-item">
													<a class="nav-link" data-toggle="tab" href="#versiones" role="tab"
														aria-expanded="false" aria-selected="false">Versiones Anteriores</a>
												</li>
												<?php
											} // end if
											
											?>
											<button class='btn btn-primary py-0 m-0' data-toggle='modal'
												data-target='#modalEditDescricionHechos'
												onclick="editDescripcion('<?= $sn['timerst'] ?>')">Editar
												Descripción</button>
										</ul>
									</div>
								</div>
								<div id="my-tab-content" class="tab-content text-center">
									<div class="tab-pane active text-left mx-5 mt-2" id="descripcion" role="tabpanel"
										aria-expanded="true">
									...
									<div class="tab-pane text-left mx-5 mt-2" id="versiones" role="tabpanel"
										aria-expanded="false">
										<div id="descripcionDeHechos" style="width:100%;">
											<div class="col-10">
												<div class="table">
			...
			<div class="col-lg-12  pl-lg-0 pr-lg-0">
				<div class="card">
					...
					<div class="card-body">
						<button onclick="vierFileCaratula('<?= $sn['timerst'] ?>','<?= $sn['folio'] ?>')"
								...
								<tbody>
									<tr>
										<td>
											...
											<span name="fechaReporte" value="<?= $sn['fechaReporte_F'] ?>"
												id="fechaReporte" type="text" class="form-control datetimepicker"
												placeholder="Fecha Reporte" required> <?= $sn['fechaReporte_F'] ?>
											</span>
										</td>
										<td>
											<label>Fecha Captura:</label>
											<span name="fechaCaptura" value="<?= $sn['fechaCaptura_F'] ?>"
												id="fechaCaptura" type="text" class="form-control "
												placeholder="Fecha Captura" required> <?= $sn['fechaCaptura_F'] ?>
											</span>
										</td>
										<td>
											<label>Fecha Asignación:</label>
											<span name="fechaAsignacion" value="<?= $sn['fechaAsignacion_F'] ?>"
												id="fechaAsignacion" type="text" class="form-control "
												placeholder="Fecha Asignación" required> <?= $sn['fechaAsignacion_F'] ?>
											</span>
										</td>
									</tr>
									...
									<tr>
										<td ondblclick="cambiaNombre()" colspan="3" class="pt-1 text-capitalize ">
											<span name="nombre" type="text" class="form-control changueinput"
												placeholder="Nombre(s)" required="">
												<?= $sn['nombre'] . ' ' . $sn['apellidoP'] . ' ' . $sn['apellidoM'] ?>
											</span>
										</td>
										<td>
											<span name="contacto">
									...
									<tr>
										<td>
											<label>Cel:</label>
											<span name="cel" value="" type="text" class="form-control" placeholder="Cel"
												required>
												<?= $sn['cel'] != '' ? $sn['cel'] : "s/n"; ?>
											</span>
										</td>
										<td>
											<label>Casa:</label>
											<span name="casa" value="" type="text" class="form-control"
										...
										<td>
											<label>Oficina:</label>
											<span name="oficina" value="" type="text" class="form-control"
												placeholder="Oficina" required>
												<?= $sn['oficina'] != '' ? $sn['oficina'] : "s/n" ?>
											</span>
										</td>
										<td>
											<label>Mail:</label>
											<span name="mail" value="" type="text" class="form-control"
									...
									<tr>
										...
										<td>
											<label>Status:</label>
											<span name="Status" value="<?= $sn['status'] ?>" type="text"
												class="form-control <?= strtolower($sn['status']) ?>"
												placeholder="Status" required> <?= $sn['status'] ?> </span>
										</td>
										<td>
											<label>Calificación:</label>
											<span name="calificacion" value="<?= $sn['calificacion'] ?>" type="text"
												class="form-control <?= strtolower($sn['calificacion']) ?>"
												placeholder="Calificación" required> <?= $sn['calificacion'] ?> </span>
										</td>
									...
									<tr>
										<td>
											...
											<span name="numReporte" value="<?= $sn['numReporte'] ?>" type="text"
												class="form-control" placeholder="Nº de Reporte" required> <?= $sn['numReporte'] ?> </span>
										</td>
										<td>
											<label>Num Siniestro:</label>
											<span name="numSiniestro" value="<?= $sn['numSiniestro'] ?>" row=2
												type="text" class="form-control" placeholder="Nº de Siniestro" required>
												<?= $sn['numSiniestro'] ?> </span>
										</td>
										...
										<td>
											<div class="row">
												<div class="col-6 mx-0 px-0" style="max-width:11em">
													...
													<span name="fechaVigencia1" value="<?= $sn['vigencia1'] ?>"
														id="fechaVigencia1" type="text" class="form-control mx-0 px-0"
														placeholder="Fecha Vigencia" required> <?= $sn['vigencia1'] ?>
													</span>
												</div>

												<div class="col-6 mx-0 px-0" style="max-width:11em">
													<label>Fecha Vigencia 2:</label>
													<span name="fechaVigencia2" value="<?= $sn['vigencia2'] ?>"
														id="fechaVigencia2" type="text" class="form-control mx-0 px-0"
														placeholder="Fin Vigencia" required> <?= $sn['vigencia2'] ?>
													</span>
												</div>
											</div>
										</td>
									...
									<tr>
										<td colspan="4">
											...
											<div class="changueinput" style="cursor:pointer"
												ondblclick="modalCambiaInstitucionSelect()">
											...
											<div class="changueinput" style="cursor:pointer"
												ondblclick="modalCambiaAutoridadSelect()">
						...
						<?php
						if ($_SESSION['id'] == 3) { ?>
							<div class="row"> <!-- solo se ve por lic tere -->
					  ...
					  NICHO -->
								...
								<div class="col-6">
									<div class="form-group">
										...
										<span name="tipoIntervencion" value="" type="text" class="form-control"
											placeholder="" opcional XD>
											<?= $sn['tipoIntervencion'] ?>
										</span>
									</div>
								</div>
								<div class="col-6">
									<div class="form-group">
										...
										<span name="tercero" value="" type="text" class="form-control" placeholder=""
											opcional XD>
											<?= $sn['tercero'] ?>
										</span>
									</div>
								...
								<div class="col-6">
									<div class="form-group">
										...
										<span name="nicho" value="" type="nicho" class="form-control" placeholder=""
											opcional XD>
											<?= $sn['nicho'] ?>
										</span>
									</div>
								...
								<div class="col-6">
									<div class="form-group">
										...
										<span name="materia" value="" type="materia" class="form-control" placeholder=""
											opcional XD>
											<?= $sn['materia'] ?>
										</span>
									</div>
								...
								<div class="col-6">
									<div class="form-group">
										...
										<span name="expediente" value="" type="expediente" class="form-control"
											placeholder="" opcional XD>
											<?= $sn['expediente'] ?>
										</span>
									</div>
			...
			<div class="card-body mt-0 pt-0">
				  <ul class="list-unstyled team-members mb-0">
							  ...
							  /* foreach ($sn['areasAsignadas'] as $k) {
																							   ...
																							   <br>
																							   <span class="d-none text-muted"><small>'.$k['descripcion'].'</small></span>
																							   </div>
			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
								  ...
								  <div class="avatar">
									...
									foreach ($sn['areasAsignadas'] as $k) {
										...
										if ($k['estatus'] == 'Activa') { //estatus de la asignacion del area al siniestro
											...
											$ars .= '<div class="tooltip"><btn onclick="asignacion(\'area\',\'desactivar\',\'' . $k['id_asignacion'] . '\')" class="btn btn-sm btn-outline-success ' . $activeClass . ' btn-round btn-icon"> <i class="fa fa-star"></i></btn><span class="tooltiptext">Desactivar</span></div> </div>';
										} else {
											...
											$ars .= '<div class="tooltip"><btn onclick="asignacion(\'area\',\'habilitar\',\'' . $k['id_asignacion'] . '\')" class="btn btn-sm btn-outline-danger ' . $activeClass . ' btn-round btn-icon"><i class="fa fa-star-o"></i></btn><span class="tooltiptext">Habilitar</span></div> </div>';
										}
										$ars .= '
                                <div class="col-md-9 col-9"> ' . $k['area'] . '
                                <br>
						...
						<div class="col-12">
							<button type="button" class="pl-2 btn btn-primary btn-md" data-toggle="modal"
								data-target="#modalAsignarArea">
								Asignar área
							</button>
						</div>
					</div>
					...
					<div class="card-body mt-0 pt-0">
						<ul class="list-unstyled team-members mb-0">
							...
							foreach ($sn['abogadosAsignados'] as $kabg) {
								$activeClass = '';
								$active = '';
								if ($kabg['usuario'] == $_SESSION['id']) {
									$active = ' style="background:#f1efd2;" ';
									$activeClass = 'active';
								}
								?>
								<li>
						...
						<div class='col-12'>
							<button type="button" class="btn btn-primary" data-toggle="modal"
								data-target="#modalAsignaAbogado">
								Asignar abogado
							</button>
						</div>
					</div>
								...
								<li>
									<div class="row" pol<?= $p['id'] ?>>
										<div class="col-md-9 col-9">
											<span class="text-muted"><small>No°: </small><b poliza>
													<?= $p['poliza'] ?>
												</b></span>
											<br>
											<span class="text-muted">Deducible: <small deducible> $
													<?= number_format($p['deducible'], 2); ?>
												</small></span> <br>
											<span class="text-muted">Reserva: <small reserva> $
													<?= number_format($p['reserva'], 2); ?>
												</small></span> <br>
											<span class="text-muted">Coaseg.: <small coaseguro> $
													<?= number_format($p['coaseguro'], 2); ?>
												</small></span> <br>
											<span class="text-muted">Sum Aseg.: <small sumaAsegurada> $
													<?= number_format($p['sumaAsegurada'], 2); ?>
												</small></span> <br>
										</div>
										<div class="col-md-3 col-3 text-right">
											<btn onclick="editPoliza(<?= $p['id'] ?>)"
			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<!-- Button trigger modal -->
						<div class="col-12">
							<button type="button" onclick="changeParam('principal','status','<?= $sn['folio'] ?>')"
								class="pl-2 btn btn-primary btn-md" data-toggle="modal"
								data-target="#modalCambiaStatus">Status</button>
						</div>

						<div class="col-12">
							<button type="button"
								onclick="changeParam('principal','calificacion','<?= $sn['folio'] ?>')"
								class="pl-2 btn btn-primary btn-md" data-toggle="modal"
								data-target="#modalCambiacalificacion">Calificacion</button>
						</div>
	...
	<!-- hasta el final tabla histórico Siniestros -->
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
				...
				<div class="card-body">
					<div id="tablaHistoricoSiniestros" class="mt-1" style="overflow-x: scroll;"></div>
				</div>
			</div>
		</div>
	</div>
...
<script defer>
	...
	function asignArea() {//? esta funcion asigna una nueva area al siniestro o ID y si trae abogados los asigna, por defaul asigna al jefe de area
		let A1 = $("#asignArea").val();
		let A2 = $("#abogados").val();
		data = { 'idArea': A1, 'idAbogado': A2, 'timerst': <?= $sn['timerst'] ?>, 'folio': <?= $sn['folio'] ?> };
		$.ajax({
			url: "./?action=siniestro/asignar&modo=asignarNuevo",// manda a asignar abogado y area segun el timerst
			method: "POST",
			data: data,
			success: function (respuesta) {
	...
	//CAMBIAR ESTATUS O CALIFICACION DE AREA
