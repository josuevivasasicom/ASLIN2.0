...
//echo print_r($sn['areasAsignadas']);

echo "<script type='text/javascript'>
    console.log(".$sn['areasAsignadas'].");
...
foreach ($sn['areasAsignadas'] as $k) {
  ...
  $type=" btn-primary ";
  if($areaIDuser != $k['id']) {$permiso=false; $type=" btn-outline-primary ";$permisoKey[str_replace(' ','',$k['area'])]=false;};
...
if(!$power){//si no está asignado, deshabilita todos los botones
  ?>
  <script>
    setTimeout(() => {
...
<?php 
foreach ($sn['areasAsignadas'] as $k) {
  ////if($areaIDuser != $k['id']) continue; //?aparece todas las areas

  $_AreaID= $k['id']; //id del area
  $_AREA = $k['area']; // nombre del area
  $_area = str_replace(' ','',$_AREA); //nombre del area sin espacios
  $notouchCLS=" ";$oculto = ' '; if(!$power || ($_AreaID=='4' || $_AreaID==5  || !$permisoKey[$_area]) ){ $notouchCLS=" notouch "; $oculto='display:none !important; pointer-events:none;'; } //si es area 4 o 5 , cntabilidad o administrativa, oculta.
                  ...
                  <div class="tab-pane text-left mx-5 mt-2" style="<?=$oculto?>" id="preliminar<?=$_area?>" role="tabpanel" aria-expanded="false">
                      <div id="informePreliminarC" style="width:100%;">
                          ...
                          if(isset($sn[$_area]['informePreliminar']['informe_preliminar'])==1){
                              ...
                              print '<center><button class="btn btn-secondary" onclick="informePreliminar('.$_AreaID.',\''.$sn['timerst'].'\')" >Cargar informe Preliminar</button> </center>';
                            };
                          ?>
                      </div>
                  </div>
                  <div class="tab-pane text-left mx-5 mt-2" style="<?=$oculto?>" id="cancelacion<?=$_area?>" role="tabpanel" aria-expanded="false">
                      <div id="informeCancelacionC" style="width:100%;">
                          ...
                          if(isset($sn[$_area]['informeCancelacion']['informe_cancelacion'])){
                              ...
                              print '<center><button class="btn btn-secondary" onclick="informeCancelacion('.$_AreaID.',\''.$sn['timerst'].'\')" >cargar informe Cancelación</button> </center>';
                            };
                          ?>
                      </div>
                  </div>
                      ...
                      <div id="informeActualizacionC" style="width:100%;">
                          ...
                          if(isset($sn[$_area]['informeActualizacion']['informe_actualizacion'])){
                            ...
                            print $sn[$_area]['informeActualizacion']['informe_actualizacion'];
                              ...
                              print '<center><button class="btn btn-secondary" onclick="informeActualizacion('.$_AreaID.',\''.$sn['timerst'].'\')" >cargar informe Actualización</button> </center>';
                            };
                          ?>
                      </div>
                  </div>
                  ...
                  <table class="table table-siniestro">
                    ...
                    <tr>
                          <td>
                            ...
                            <span name="fechaReporte" id="fechaReporte" type="text" class="form-control datetimepicker" placeholder="Fecha Reporte" required><?=$sn['fechaReporte_F']?> </span>
                            <!-- <input name="fechaReporte" value="<?=$sn['fechaReporte_F']?>" id="fechaReporte" type="text" class="form-control datetimepicker" placeholder="Fecha Reporte" required> -->
                          </td>
                          <td>
                            <label>Fecha Captura:</label>
                            <span name="fechaCaptura" id="fechaCaptura" type="text" class="form-control " placeholder="Fecha Captura" required><?=$sn['fechaCaptura_F']?> </span>
                            <!-- <input name="fechaCaptura" value="<?=$sn['fechaCaptura_F']?>" id="fechaCaptura" type="text" class="form-control " placeholder="Fecha Captura" required> -->
                          </td>
                          <td>
                            <label>Fecha Asignación:</label>
                            <span name="fechaAsignacion" id="fechaAsignacion" type="text" class="form-control " placeholder="Fecha Asignación" required><?=$sn['fechaAsignacion_F']?> </span>
                            <!-- <input name="fechaAsignacion" value="<?=$sn['fechaAsignacion_F']?>" id="fechaAsignacion" type="text" class="form-control " placeholder="Fecha Asignación" required> -->
                          </td>
                      </tr>
                      ...
                      <tr>
                          ...
                          <td>
                            <label>Status:</label>
                            <span name="Status" type="text" class="form-control <?=strtolower($sn['status'])?>" placeholder="Status" required> <?=$sn['status']?> </span>
                      ...
                      <td>
                            ...
                            <span name="numReporte" type="text" class="form-control" placeholder="Nº de Reporte" required> <?=$sn['numReporte']?>  </span>
                            <!-- <input name="numReporte" type="text" class="form-control" placeholder="Nº de Reporte" required> -->
                          </td>
                          <td>
                            <label>Num Siniestro:</label>
                            <span name="numSiniestro" row=2 type="text" class="form-control" placeholder="Nº de Siniestro" required> <?=$sn['numSiniestro']?>  </span>
                            <!-- <input name="numSiniestro" row=2 type="text" class="form-control" placeholder="Nº de Siniestro" required> -->
                          </td>
                          ...
                          <label>Fecha Vidgencia inicio:</label>
                          <span name="fechaVigencia1" id="fechaVigencia1" type="text" class="form-control mx-0 px-0" placeholder="Fecha Vigencia" required>   <?=$sn['vigencia1']?>  </span>
                          <!-- <input name="fechaVigencia1" id="fechaVigencia1" type="text" class="form-control mx-0 px-0" placeholder="Fecha Vigencia" required> -->
                          </div>

                          <div class="col-6 mx-0 px-0" style="max-width:11em">
                            <label>Fecha Vigencia fin:</label>
                            <span name="fechaVigencia2" id="fechaVigencia2" type="text" class="form-control mx-0 px-0" placeholder="Fin Vigencia" required> <?=$sn['vigencia2']?>  </span>
                            <!-- <input name="fechaVigencia2" id="fechaVigencia2" type="text" class="form-control mx-0 px-0" placeholder="Fin Vigencia" required> -->
                            </div>
                          </div>
                          </td>
                      </tr>
