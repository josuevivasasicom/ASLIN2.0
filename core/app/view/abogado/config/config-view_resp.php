            ...
            <div class="card card-user">
                ...
                <div class="card-body">
                    ...
                    <p class="description text-center">
                        "Responsable de los siniestros recien creados."
                    </p>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md pl-1">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="CP" value="<?=$us['cp']?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md pr-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Dirección" value="<?=$us['direccion']?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md pr-1">
                                <div class="form-group">
                                    <label>Cédula</label>
                                    <input type="text" class="form-control" placeholder="Cédula" value="<?=$us['celular']?>cedula">
                                </div>
                            </div>
                        </div>
