<?php
$TotalSiniestros = SiniestrosAbogado::countTodosSiniestros();
$TotalSiniestrosProcesoCancelacion = SiniestrosAbogado::countTodosSiniestrosProcesoCancelacion();
$TotalSiniestrosVigentes = SiniestrosAbogado::countTodosSiniestrosVigentes();
$TotalSiniestrosCancelados = SiniestrosAbogado::countTodosSiniestrosCancelados();
?>
<div class="content">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-7 col-md-8 pl-0">
              <div class="numbers">
                <p class="card-category">ID PC</p>
                <p class="card-title">
                  <?= $TotalSiniestrosProcesoCancelacion ?>
                <p>
              </div>
            </div>
          </div>
      ...
      <div class="card card-stats">
        <div class="card-body">
          <div class="row">
            <div class="col-5 col-md-4">
              <div class="icon-big text-center icon-warning">
                <i class="nc-icon nc-basket text-primary"></i>
              </div>
            </div>
            <div class="col-7 col-md-8">
              <div class="numbers">
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <p class="card-category">Gráfica de siniestros</p>
        </div>
        <div class="card-body">
...
<script type="text/javascript" defer>
  ...
  function prep_chartsPage() {
    ...
    $.ajax({
      url: "./?action=charts/abogado/index_todosSiniestros",
      method: "POST",
      data: {},
      cache: false,
    ...
    $.ajax({
      url: "./?action=charts/abogado/index_todosID",
      method: "POST",
      data: {},
      cache: false,
      success: function (respuesta) {
    ...
    $.ajax({
      url: "./?action=charts/abogado/index_status",
      method: "POST",
      data: {},
      cache: false,
      success: function (respuesta) {
