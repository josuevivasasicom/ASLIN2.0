<?php
$TotalSiniestros= Siniestros::countTodosSiniestros('',UserData::getPerfil()[1]);
...
core::preprint(UserData::getPerfil()[1]);
?>
<div class="content">
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"> <?=$TotalSiniestrosVigentes;?><p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8 pl-0">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?=$TotalSiniestrosProcesoCancelacion?><p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?=$TotalSiniestrosCancelados?><p>
                    </div>
                  </div>
                </div>
              </div>
