...
class TablaSiniestros{
  ...
  public function mostrarTablaSiniestrosProv($prov,$status,$area,$asignados,$abogados,$calificacion){ //SE EJECUTA POR DEFAULT
    ...
    //? Trae todos los siniestros
    //todos
        $datosSiniestros = Siniestros::getTodosSiniestros($orden,$limitInf,$limitSup,$prov,$status,$area,$calificacion,$asignados);
...
if( 
  ...
  $activar -> mostrarTablaSiniestrosProv($provSelected, $statusSelected,$area,$asignados,$abogados=[],$calificacionSelected);
