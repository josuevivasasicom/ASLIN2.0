...
class Correo
{
    ...
    */
    ...
    public static function sendMailFiles($msg,$email,$subject,$debug=0,$file=0,$filename='')
    {
        ...
        $mail->CharSet = 'UTF-8';
        $mail->setFrom('alertas@claimsmanager.online', 'INFO');
        // $mail->addReplyTo('contacto@asicom.com', 'GRUPO');
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="left" valign="top">
                                                                                                                <table width="105" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                                                    <tbody>
                                                                                                                        <tr>
                                                                                                                            <td width="95" align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; text-transform:uppercase; color:#FFF;"><a href="https://claimsmanager.online" target="_blank" style="text-decoration:none; color:#FFF;">Ir a CMA App </a></td>
                                                                                                                            <td width="10" align="center" valign="middle"><img src="https://claimsmanager.online/assets/img/icons/read-more.png" width="10" height="10" alt="" style="display:block;"></td>
                                                                                                                        </tr>
                                                                                                                    </tbody>
                                                                                                                </table>
    ...
    public static function send_format($data)
    {
        ...
        if (isset($data['linkfile'])){  // si este existe, el link es de un archivo verdadero.
            ...
            $pdfdoc = file_get_contents($data['link']);
