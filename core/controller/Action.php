...
class Action {
	/**
	* @function load
	* @elmm la funcion load carga una vista correspondiente a un modulo
	**/	
	public static function load($action){
		...
		if(!isset($_GET['action'])){
			...
			if(Action::isValid()){
				...
				Action::Error("<b>404 NOT FOUND</b> Action <b>".$_GET['action']."</b> folder  !! - <a href='m3c.com.mx/legobox/help/' target='_blank'>Help</a>");
			}
	...
	/**
	* @function isValid
	* @elmm valida la existencia de una vista
	**/	
