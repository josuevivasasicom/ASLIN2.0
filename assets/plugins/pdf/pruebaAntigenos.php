	...
	<div style="text-align: center; height: 100%; position: absolute;">
		...
		<div style="position: absolute; top: 10%; left: 50%; margin-left: -50%; text-align: left; margin-top: 0%;">
			...
			<p>Estimated <strong><?php echo $datos["paciente"];?></strong> result of the test that was carried out <strong><?php echo $fechaIn;?></strong> was <strong><?=$resultado?></strong>.
			<br>
		...
		<div style="width: 99%; text-align: left; margin-left: 0%; position: absolute; top: 21%;"> 
			...
			<table style="width: 100%; text-align: center; margin-top: 0%;">
				...
				<tr>
					...
					<td style="width: 40%;  color: #000000; text-align: left;"><h5 style="font-weight: normal; text-align: center;">Antígenos Rápido de SARS-CoV-2</h5></td>
